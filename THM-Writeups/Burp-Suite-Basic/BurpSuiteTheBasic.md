...
Dashboard adalah pusat kendali Burp Suite. Di versi **Community 2026.1.1** yang lu pake, fitur ini memberikan ringkasan aktivitas sistem:
...
- **Shortcut**: Lu bisa pake `Ctrl + Shift + D` buat langsung loncat ke tab Dashboard.
...
- **Intercept is on/off**: Tombol sakti untuk menentukan apakah trafik mau ditahan atau dibiarkan lewat begitu saja.

---

### Target Scoping & Site Map

Agar fokus dan nggak menuh-menuhin log dengan trafik yang nggak penting (kayak _update_ Arch di _background_), lu butuh **Scoping**:
