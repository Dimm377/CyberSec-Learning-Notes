...
**Konsep:**
*   Dipake waktu teknik In-Band dan Blind tidak memungkinkan (misal, pemrosesan asinkron).
*   Ngandelin kemampuan server database buat membuat request DNS atau HTTP buat mengirim data ke server yang dikontrol penyerang.

**Contoh (MSSQL pakai `xp_dirtree`):**
