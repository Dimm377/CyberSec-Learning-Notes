...
- **Answer:** 0011
  _(Clue: 1$\oplus$1=0, 0$\oplus$0=0, 0$\oplus$1=1, 1$\oplus$0=1)_

- **Question:** What's 118613842 % 9091?
- **Answer:** 3565
  _(Clue: bisa pake Python di terminal lu: `python3 -c "print(118613842 % 9091)"`)_

- **Question:** What's 60 % 12?
- **Answer:** 0
  _(Clue: 60 habis dibagi 12, jadi sisanya adalah 0)_
